...
//go:generate mockgen -destination ../mocks/user_config_context_loader.go -package mocks -mock_names ContextLoader=UserConfigContextLoader github.com/yolo-sh/hetzner-cloud-provider/userconfig ContextLoader
